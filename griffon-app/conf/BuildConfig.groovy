griffon.project.dependency.resolution = {
    ...
    repositories {
        ...
        flatDir name: "guiceLibDir", dirs: ["${basePath}lib"]
    }
    dependencies {
        String guiceVersion = '3.0'
        compile 'aopalliance:aopalliance:1.0',
                'javax.inject:javax.inject:1',
                "com.google.code.guice:guice:$guiceVersion",
                "com.google.code.guice:guice-assistedinject:$guiceVersion",
                "com.google.code.guice:guice-multibindings:$guiceVersion"
    }
}
